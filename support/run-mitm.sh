...
# Start peripheral (target)
peripheral_exe="${this_dir}/firmware/peripheral/build/zephyr/zephyr.exe"
$peripheral_exe -s=lisp-id -d=2 -RealEncryption=0 -rs=70 &

# Start central
central_exe="${this_dir}/firmware/central/build/zephyr/zephyr.exe"
$central_exe -s=lisp-id -d=3 -RealEncryption=0 -rs=788 &
...
./bs_2G4_phy_v1 -s=lisp-id -D=4 -dump_imm
